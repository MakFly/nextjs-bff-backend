...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BxE39KW-.mjs");
...
const manifest = { "c833b877e95a830e50a8701ab1f8d7e4ee0d91d0ff26c91b9d2a6d517510dc99": {
  functionName: "loginFn_createServerFn_handler",
  importer: () => import("./auth-gE0sToFU.mjs")
}, "45280bcad0cbaef0249b9266840e3e84186ba9c130d7fd65c23401620db41dc9": {
  functionName: "registerFn_createServerFn_handler",
  importer: () => import("./auth-gE0sToFU.mjs")
}, "11187666f1dc17722763bd44c34030ba5781e256f7e5d4089eb6d560714404b9": {
  functionName: "logoutFn_createServerFn_handler",
  importer: () => import("./auth-gE0sToFU.mjs")
}, "52b278cd5f2cd78059dd8070825943e5d7231514ed87d25bb929795cc5caff4a": {
  functionName: "getCurrentUserFn_createServerFn_handler",
  importer: () => import("./auth-gE0sToFU.mjs")
}, "781d51dc057199d9ddf12871dc6144ddd9ec4a84e0b4ba2055cea3a022e3ea89": {
  functionName: "refreshTokenFn_createServerFn_handler",
  importer: () => import("./auth-gE0sToFU.mjs")
}, "cba48e5dfb9016e9b2d8c03f0636ce8582b3a98d31652ab501f25b9043fab876": {
  functionName: "getOAuthUrlFn_createServerFn_handler",
  importer: () => import("./auth-gE0sToFU.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-BarhrSOS.mjs").then((n2) => n2.r);
